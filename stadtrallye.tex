...
\footrule
\footer{\footnotesize Stadtrallye WS21/22}
{}
...
\vspace{0.5cm}
\noindent
\uline{Gruppe:\hspace{2cm} \hfill Bearbeitungszeit: 90 min   \hfill     Treffpunkt: Süd-Ende Bota}
%Kleiner Abstand zwischen Header und Fragen
\vspace{0.5cm}\\
Findet euch in Gruppen mit je \textbf{5 ($\pm$2) Personen} zusammen. Ihr habt \textbf{90 min} um so viele Aufgaben wie möglich zu lösen und fleißig Punkte zu sammeln. Der \textbf{Treffpunkt ist der Süd / Altstadt-Eingang des alten Botas}. Wird die Bearbeitungszeit überschritten muss mit Punktabzug gerechnet werden. Anschließend ziehen wir gemeinsam durch die Tübinger Kneipen.
...
\begin{tabularx}{19cm}{XX}
	\includegraphics[width=7.5cm]{graphics/suche_1} & \includegraphics[width=7.5cm]{graphics/suche_2} \\ \includegraphics[width=7.5cm]{graphics/suche_3} & \includegraphics[width=7.5cm]{graphics/suche_4} \\ \includegraphics[width=7.5cm]{graphics/suche_5} & \includegraphics[width=7.5cm]{graphics/suche_6}
\end{tabularx}
\end{document} 